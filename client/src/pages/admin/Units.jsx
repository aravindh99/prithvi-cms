      ...
      <div className="min-h-screen p-4 sm:p-6 md:p-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 sm:mb-6 md:mb-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800">Units</h1>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {units.map((unit) => (
              <div key={unit.id} className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                <div className="text-xl sm:text-2xl font-bold text-gray-800 mb-2">{unit.name}</div>
                <div className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4">Code: {unit.code}</div>
