      ...
      >
        <div className="relative w-full max-w-5xl shadow-2xl rounded-3xl overflow-hidden border border-white/10 bg-slate-900/60 backdrop-blur-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div className="relative h-56 md:h-full bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(59,130,246,0.25),transparent_35%)]" />
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_10%,rgba(16,185,129,0.15),transparent_30%)]" />
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-900/60 border border-slate-700 focus:border-emerald-400 focus:ring-2 focus:ring-emerald-400/40 text-slate-50 placeholder:text-slate-500"
                    required
                    autoFocus
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 text-slate-950 font-semibold shadow-lg shadow-emerald-500/30 hover:translate-y-[-1px] transition-all disabled:opacity-60"
                >
